...
class HailCars:
    ...
    def olx(self):
        ...
        for location in Locations:
            ...
            hw.wait_explicitly(By.XPATH, f"//span[contains(.,'Used')]/parent::label/preceding-sibling::input[@type='checkbox']")
            ...
            time.sleep(0.5)
            for make in makes:
                hw.wait_explicitly(By.XPATH,f"//span[.='{make}']", timeout=10)
                hw.scroll_to_element(By.XPATH,f"//span[.='{make}']")
